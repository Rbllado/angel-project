      ...
      <div className="container">
        ...
        <div className="">
          ...
          <CardDeck>
            <Card>
              <br></br>
              <svg class="bi bi-info-circle" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              ...
              <br></br>
              <svg class="bi bi-card-heading" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              ...
              <svg class="bi bi-chevron-bar-contract text-danger" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              ...
              <br></br>
              <svg class="bi bi-calendar bg-white text-dark" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <CardDeck>
            <Card>
              <br></br>
              <svg class="bi bi-lightning-fill text-warning" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              ...
              <br></br>
              <svg class="bi bi-hammer" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              <br></br>
              <svg class="bi bi-tools text-info" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              <br></br>
              {/* <Card.Img variant="top" height="200px" src="/images/indent-solid.svg" /> */}
              <svg class="bi bi-building text-muted" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <CardDeck>
            <Card>
              {/* <Card.Img variant="top" height="200px" src="/images/indent-solid.svg" /> */}
              <br></br>
              <svg class="bi bi-file-check text-success" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              <br></br>
              <svg class="bi bi-geo-alt text-primary" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <Card>
              <br></br>
              <svg class="bi bi-phone text-secondary" margin-top="30px" width="250px" height="100px" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
